...
def test_build_catalog_writes_gzip_tsv(tmp_path):
    ...
    cis_path = tmp_path / 'local_analysis_per_element_output.tsv.gz'
    trans_path = tmp_path / 'global_analysis_per_element_output.tsv.gz'
    ...
    catalog_builder.build_catalog_per_element_output(
        local_analysis_per_element_path=str(cis_path),
        global_analysis_per_element_path=str(trans_path),
