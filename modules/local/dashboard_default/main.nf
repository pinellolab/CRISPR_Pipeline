...
EOF_DASHBOARD_PARAMS
        ...
        create_dashboard_df.py --json_dir json_dir --guide_fq_tbl ${guide_fq_tbl} --mudata input_mudata.h5mu --gene_ann ${gene_ann} --gene_ann_filtered ${gene_ann_filtered} --guide_ann ${guide_ann} --params_json dashboard_params.json --additional_qc_dir additional_qc --benchmark_dir benchmark_output --default --qc_metrics_json pipeline_qc_metrics.json
