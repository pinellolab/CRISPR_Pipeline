...
def merge_local_global_results(
    ...
    local_per_guide = pd.read_csv(local_analysis_per_guide_path, sep="\t")
    local_per_element = pd.read_csv(local_analysis_per_element_path, sep="\t")
    global_per_guide = pd.read_csv(global_analysis_per_guide_path, sep="\t")
    global_per_element = pd.read_csv(global_analysis_per_element_path, sep="\t")
    ...
    local_per_guide.to_csv("local_analysis_per_guide_output.tsv.gz", sep="\t", index=False, compression="gzip")
    local_per_element.to_csv("local_analysis_per_element_output.tsv.gz", sep="\t", index=False, compression="gzip")
    global_per_guide.to_csv("global_analysis_per_guide_output.tsv.gz", sep="\t", index=False, compression="gzip")
    global_per_element.to_csv("global_analysis_per_element_output.tsv.gz", sep="\t", index=False, compression="gzip")
