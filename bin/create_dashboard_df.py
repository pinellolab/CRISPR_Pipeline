...
def create_dashboard_df(guide_fq_tbl, mudata_path, gene_ann_path, filtered_ann_path, guide_ann_path, json_dir=None, params_json=None, params_dir=None, additional_qc_dir=None, benchmark_dir=None, use_default=False):
    ...
    return guide_check_df, cell_stats, gene_stats, flow_block, rna_img_df, guide_img_df, inference_blocks, gs_img_df, inf_img_df, qc_blocks, benchmark_block
...
def main():
    ...
    guide_check_df, cell_stats, gene_stats, flow_block, rna_img_df, guide_img_df, inference_blocks, gs_img_df, inf_img_df, qc_blocks, benchmark_block = create_dashboard_df(
        args.guide_fq_tbl,
        args.mudata,
        args.gene_ann,
